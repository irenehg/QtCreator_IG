...
void _gl_widget::keyPressEvent(QKeyEvent *Keyevent)
{
  ...
  case Qt::Key_7:Object=OBJECT_BATIDORA_JERARQUICO;break;
...
void _gl_widget::draw_objects()
{
  ...
  if (Draw_point){
    ...
    case OBJECT_BATIDORA_JERARQUICO:Batidora.draw_point();break;
    default:break;
    }
  }
  ...
  if (Draw_line){
    ...
    case OBJECT_BATIDORA_JERARQUICO:Batidora.draw_line();break;
    default:break;
    }
  }
  ...
  if (Draw_fill){
    ...
    case OBJECT_BATIDORA_JERARQUICO:Batidora.draw_fill();break;
    default:break;
    }
  }
  ...
  if (Draw_chess){
    ...
    case OBJECT_BATIDORA_JERARQUICO:Batidora.draw_chess();break;
    default:break;
    }
  }

  limiteAngulos();
  Batidora.rotar_primer_grado(alpha);
  //Batidora.rotar_segundo_grado(beta);
  //Batidora.rotar_tercer_grado(gamma);
